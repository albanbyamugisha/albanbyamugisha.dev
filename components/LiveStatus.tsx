...
const LiveStatus = () => {
  ...
  return (
    <motion.div
      ...
      className="inline-flex items-center rounded-full bg-linear-to-r from-emerald-400/60 via-cyan-300/40 to-emerald-400/60 p-px shadow-[0_0_22px_rgba(34,197,94,0.35),0_16px_40px_rgba(3,7,18,0.65)]"
    >
      <div className="navbar-status inline-flex items-center gap-2 rounded-full bg-slate-950/60 px-3 py-1.5 text-[0.7rem] sm:text-[0.75rem] text-emerald-50/90 backdrop-blur-xl">
